...
class Rave extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $config = Configuration::getMultiple(array('RAVE_LIVE_SECRETKEY', 'RAVE_LIVE_PUBLICKEY', 'RAVE_TEST_SECRETKEY', 'RAVE_TEST_PUBLICKEY', 'RAVE_MERCHANT_TITLE', 'RAVE_MERCHANT_DESCRIPTION', 'RAVE_META_NAME', 'RAVE_META_VALUE', 'RAVE_ENV'));
    ...
    public function uninstall()
    {
        if (
            ...
            || !Configuration::deleteByName('RAVE_MERCHANT_TITLE')
            || !Configuration::deleteByName('RAVE_MERCHANT_LOGO')
            || !Configuration::deleteByName('RAVE_META_NAME')
            || !Configuration::deleteByName('RAVE_META_VALUE')
            || !parent::uninstall()
        ) {
            return false;
        }
    ...
    protected function _postProcess()
    {
        if (Tools::isSubmit('btnSubmit')) {
            ...
            Configuration::updateValue('RAVE_MERCHANT_TITLE', Tools::getValue('RAVE_MERCHANT_TITLE'));
            Configuration::updateValue('RAVE_MERCHANT_LOGO', Tools::getValue('RAVE_MERCHANT_LOGO'));
            Configuration::updateValue('RAVE_META_NAME', Tools::getValue('RAVE_META_NAME'));
            Configuration::updateValue('RAVE_META_VALUE', Tools::getValue('RAVE_META_VALUE'));
        ...
        $fields_form = array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'text',
                        'label' => $this->trans('Modal Title', array(), 'Modules.Rave.Admin'),
                        'name' => 'RAVE_MERCHANT_TITLE',
                        'required' => false
                    ),
                    array(
                        'type' => 'text',
                        'label' => $this->trans('Modal Logo (preferrably a square size)', array(), 'Modules.Rave.Admin'),
                    ...
                    array(
                        'type' => 'text',
                        'label' => $this->trans('Meta Value (optional)', array(), 'Modules.Rave.Admin'),
                        'name' => 'RAVE_META_VALUE',
                        'required' => false
                    )
                ),
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'RAVE_MERCHANT_TITLE' => Tools::getValue('RAVE_MERCHANT_TITLE', Configuration::get('RAVE_MERCHANT_TITLE')),
            'RAVE_MERCHANT_LOGO' => Tools::getValue('RAVE_MERCHANT_LOGO', Configuration::get('RAVE_MERCHANT_LOGO')),
            'RAVE_META_NAME' => Tools::getValue('RAVE_META_NAME', Configuration::get('RAVE_META_NAME')),
            'RAVE_META_VALUE' => Tools::getValue('RAVE_META_VALUE', Configuration::get('RAVE_META_VALUE')),
